...
Tabs.Info:AddButton({
        ...
        Callback=function()
            setclipboard(tostring("https://t.me/hirumodez")) 
        end
})
Tabs.Info:AddButton({
    Title="Nguyễn Hoàng Tâm",
    Description="Youtube",
    Callback=function()
        setclipboard(tostring("https://www.youtube.com/@HIRUMOD"))
    end
})
Tabs.Info:AddButton({
    Title="Nguyễn Hoàng Tâm",
    ...
    Callback=function()
        setclipboard(tostring("https://www.facebook.com/share/19YxiZCVsT/"))
    end
})
    ...
    task.spawn(function()
        while task.wait() do
            pcall(function()
                ...
                if moonTextureId=="http://www.roblox.com/asset/?id=75262510138627" then
                    FullMoonStatus="100%"
                elseif moonTextureId=="http://www.roblox.com/asset/?id=75262510138627" then
                    FullMoonStatus="75%"
                elseif moonTextureId=="http://www.roblox.com/asset/?id=75262510138627" then
                    FullMoonStatus="50%"
                elseif moonTextureId=="http://www.roblox.com/asset/?id=75262510138627" then
    ...
    function getHighestPoint()
        ...
        for _, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId=="rbxassetid://75262510138627" then
                    return v
                end
            end
        end
